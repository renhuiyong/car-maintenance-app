		...
		<view class="message-section">
			...
			<view class="message-list">
				<view class="message-item">
					<text class="unread">未读</text>
					<text class="content">您的订单已收货</text>
					<image class="arrow" src="/static/images/youjiantou2.png"></image>
				</view>
				<view class="message-item">
					<text class="content">您的订单未付款</text>
					<image class="arrow" src="/static/images/youjiantou2.png"></image>
				</view>
				<view class="message-item">
					<text class="content">最新活动通知，请查看活动详情</text>
					<image class="arrow" src="/static/images/youjiantou2.png"></image>
				</view>
				<view class="message-item">
					<text class="content">您收到一笔推广佣金</text>
					<image class="arrow" src="/static/images/youjiantou2.png"></image>
				</view>
			</view>
		</view>
