        ...
        <view class="content-wrapper">
          ...
          <view class="repair-info">
            ...
            <view class="voice-wrapper" v-if="orderInfo.voicePath">
              <view class="voice-player" @click="playVoice(orderInfo.voicePath)">
                <image src="/static/images/voice.png" mode="aspectFit"></image>
          ...
          <view class="amount-section">
            <view class="amount-item">
              <text>维修费用</text>
              <text class="amount">¥{{ orderInfo.orderAmount.toFixed(2) }}</text>
            </view>
            ...
            <view class="amount-item">
              <text>订单总额</text>
              <text class="amount highlight">¥{{ orderInfo.totalAmount.toFixed(2) }}</text>
            </view>
          </view>
