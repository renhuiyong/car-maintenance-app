...
export default {
  ...
  methods: {
    ...
    enterShop() {
      ...
      uni.navigateTo({
        url: `/packageUser/pages/shop/shop?shopId=${this.shopId}&shopName=${this.merchantInfo.name}`
      })
    },
    goToRepair() {
      // 构造需要传递的商家信息对象
    ...
    initShareConfig() {
      this.shareConfig = {
        ...
        path: `/packageMerchant/pages/merchantDetails/merchantDetails?shopId=${this.shopId}&latitude=${this.currentLatitude}&longitude=${this.currentLongitude}`,
